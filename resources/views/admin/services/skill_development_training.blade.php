...
<div class="card w-100">
    <div class="card-body">
      <h5 class="card-title fw-semibold mb-4" id="heading-color">Add Skill Development and Training</h5>
        @if(session('success'))
            ...
            <form action="{{ route('admin.skill-development-training.update') }}" method="post" enctype="multipart/form-data">
                ...
                <div class="row">
                    <div class="mb-3 col-md-6">
                        ...
                        <input type="hidden" name="id" value="{{ !empty($skillDev->id) ?   $skillDev->id : '' }}"/>
                    ...
                    <div class="mb-3 col-md-6">
                        ...
                        <textarea type="text" name="content_1" class="form-control" placeholder="Enter blog content"> {{ !empty($skillDev->content_1) ? $skillDev->content_1 : '' }}</textarea>
                    ...
                    <div class="mb-3 col-md-6">
                        ...
                        <textarea type="text" name="content_2" class="form-control" placeholder="Enter blog content"> {{ !empty($skillDev->content_2) ? $skillDev->content_2 : '' }} </textarea>
                    ...
                    <div class="mb-3 col-md-6">
                        ...
                        <textarea type="text" name="content_3" class="form-control" placeholder="Enter content 3"> {{ !empty($skillDev->content_3) ? $skillDev->content_3 : '' }} </textarea>
                ...
                <div class="row">
                    ...
                    <div class="mb-3 col-md-6">
                        <label for="" class="form-label">Content 1</label>
                        <textarea type="text" name="key_benefit_content_1" class="form-control" placeholder="Enter blog content"> {{ !empty($skillDev->key_benefit_content_1) ? $skillDev->key_benefit_content_1 : '' }}  </textarea>
                    ...
                    <div class="mb-3 col-md-6">
                        <label for="" class="form-label">Content 2</label>
                        <textarea type="text" name="key_benefit_content_2" class="form-control" placeholder="Enter blog content"> {{ !empty($skillDev->key_benefit_content_2) ? $skillDev->key_benefit_content_2 : '' }} </textarea>
                    ...
                    <div class="mb-3 col-md-6">
                        <label for="" class="form-label">Content 3</label>
                        <textarea type="text" name="key_benefit_content_3" class="form-control" placeholder="Enter content 3"> {{ !empty($skillDev->key_benefit_content_3) ? $skillDev->key_benefit_content_3 : '' }} </textarea>
                    ...
                    <div class="mb-3 col-md-6">
                        ...
                        <textarea type="text" name="key_benefit_content_4" class="form-control" placeholder="Enter blog content"> {{ !empty($skillDev->key_benefit_content_4) ? $skillDev->key_benefit_content_4 : '' }}</textarea>
                    ...
                    <div class="mb-3 col-md-6">
                        ...
                        <textarea type="text" name="key_benefit_content_5" class="form-control" placeholder="Enter content 5"> {{ !empty($skillDev->key_benefit_content_5) ? $skillDev->key_benefit_content_5 : '' }} </textarea>
                ...
                <div class="row">
                    ...
                    <div class="mb-3 col-md-6">
                        <label for="" class="form-label">Content 1</label>
                        <textarea type="text" name="choose_us_content_1" class="form-control" placeholder="Enter blog content"> {{ !empty($skillDev->choose_us_content_1) ? $skillDev->choose_us_content_1 : '' }} </textarea>
                    ...
                    <div class="mb-3 col-md-6">
                        <label for="" class="form-label">Content 2</label>
                        <textarea type="text" name="choose_us_content_2" class="form-control" placeholder="Enter blog content">{{ !empty($skillDev->choose_us_content_2) ? $skillDev->choose_us_content_2 : '' }}</textarea>
                    ...
                    <div class="mb-3 col-md-6">
                        <label for="" class="form-label">Content 3</label>
                        <textarea type="text" name="choose_us_content_3" class="form-control" placeholder="Enter content 3"> {{ !empty($skillDev->choose_us_content_3) ? $skillDev->choose_us_content_3 : '' }} </textarea>
                    ...
                    <div class="mb-3 col-md-6">
                        <label for="" class="form-label">Content 4</label>
                        <textarea type="text" name="choose_us_content_4" class="form-control" placeholder="Enter blog content"> {{ !empty($skillDev->choose_us_content_4) ? $skillDev->choose_us_content_4 : old('choose_us_content_4') }} </textarea>
                ...
                <div class="row">
                    ...
                    <div class="mb-3 col-md-6">
                        ...
                        <textarea type="text" name="faq_content_6" class="form-control" placeholder="Enter content"> {{ !empty($skillDev->faq_content_6) ? $skillDev->faq_content_6 : old('faq_content_5') }} </textarea>
