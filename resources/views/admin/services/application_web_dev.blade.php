...
<div class="card w-100">
    <div class="card-body">
      <h5 class="card-title fw-semibold mb-4" id="heading-color">Add Application and Web Development</h5>
        @if(session('success'))
            ...
            <form action="{{ route('admin.application-web-development.update') }}" method="post" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <div class="mb-3 col-md-6">
                        ...
                        <textarea type="text" name="content_1" class="form-control" placeholder="Enter blog content"> {{ !empty($applicationWeb->content_1) ? $applicationWeb->content_1 : old('content_1') }}</textarea>
                    ...
                    <div class="mb-3 col-md-6">
                        ...
                        <textarea type="text" name="content_2" class="form-control" placeholder="Enter blog content"> {{ !empty($applicationWeb->content_2) ? $applicationWeb->content_2 : old('content_2') }} </textarea>
                ...
                <div class="row">
                    ...
                    <div class="mb-3 col-md-6">
                        <label for="" class="form-label">Content 1</label>
                        <textarea type="text" name="key_benefit_content_1" class="form-control" placeholder="Enter blog content"> {{ !empty($applicationWeb->key_benefit_content_1) ? $applicationWeb->key_benefit_content_1 : old('key_benefit_content_1') }}  </textarea>
                    ...
                    <div class="mb-3 col-md-6">
                        <label for="" class="form-label">Content 2</label>
                        <textarea type="text" name="key_benefit_content_2" class="form-control" placeholder="Enter blog content"> {{ !empty($applicationWeb->key_benefit_content_2) ? $applicationWeb->key_benefit_content_2 : old('key_benefit_content_2') }} </textarea>
                    ...
                    <div class="mb-3 col-md-6">
                        ...
                        <textarea type="text" name="key_benefit_content_4" class="form-control" placeholder="Enter blog content"> {{ !empty($applicationWeb->key_benefit_content_4) ? $applicationWeb->key_benefit_content_4 : old('key_benefit_content_4') }}</textarea>
                ...
                <div class="row">
                    ...
                    <div class="mb-3 col-md-6">
                        <label for="" class="form-label">Content 1</label>
                        <textarea type="text" name="choose_us_content_1" class="form-control" placeholder="Enter blog content"> {{ !empty($applicationWeb->choose_us_content_1) ? $applicationWeb->choose_us_content_1 : '' }} </textarea>
                    ...
                    <div class="mb-3 col-md-6">
                        <label for="" class="form-label">Content 2</label>
                        <textarea type="text" name="choose_us_content_2" class="form-control" placeholder="Enter blog content">{{ !empty($applicationWeb->choose_us_content_2) ? $applicationWeb->choose_us_content_2 : old('choose_us_content_2') }}</textarea>
                    ...
                    <div class="mb-3 col-md-6">
                        <label for="" class="form-label">Content 4</label>
                        <textarea type="text" name="choose_us_content_4" class="form-control" placeholder="Enter blog content"> {{ !empty($applicationWeb->choose_us_content_4) ? $applicationWeb->choose_us_content_4 : old('choose_us_content_4') }} </textarea>
