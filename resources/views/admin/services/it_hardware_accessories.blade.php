...
<div class="card w-100">
    <div class="card-body">
      <h5 class="card-title fw-semibold mb-4" id="heading-color">Add IT Hardware accessories</h5>
        @if(session('success'))
        ...
        @endif
        <div class="container">
            <form action="{{ route('admin.it-hardwares-accessories.update') }}" method="post" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    ...
                    <div class="mb-3 col-md-6">
                        ...
                        <textarea type="text" name="content_1" class="form-control" placeholder="Enter blog content"> {{ !empty($nonItRecruitment->content_1) ? $nonItRecruitment->content_1 : old('content_1') }}</textarea>
                    ...
                    <div class="mb-3 col-md-6">
                        ...
                        <textarea type="text" name="content_2" class="form-control" placeholder="Enter blog content"> {{ !empty($nonItRecruitment->content_2) ? $nonItRecruitment->content_2 : old('content_2') }} </textarea>
                    ...
                    <div class="mb-3 col-md-6">
                        ...
                        <textarea type="text" name="content_3" class="form-control" placeholder="Enter content 3"> {{ !empty($nonItRecruitment->content_3) ? $nonItRecruitment->content_3 : old('content_3') }} </textarea>
                    ...
                    <div class="mb-3 col-md-6">
                        ...
                        <input type="file" name="it_hardware_ass_image" class="form-control">
                        @if(!empty($nonItRecruitment->it_hardware_ass_image))
                        <img class="mt-2" src="{{asset('uploads/services/'.$nonItRecruitment->it_hardware_ass_image)}}" height="80"  width="80"  />
                        @endif
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="mb-3 col-md-6">
                        <label for="" class="form-label">Content 1</label>
                        <textarea type="text" name="key_benefit_content_1" class="form-control" placeholder="Enter blog content"> {{ !empty($nonItRecruitment->key_benefit_content_1) ? $nonItRecruitment->key_benefit_content_1 : old('key_benefit_content_1') }}  </textarea>
                    ...
                    <div class="mb-3 col-md-6">
                        <label for="" class="form-label">Content 2</label>
                        <textarea type="text" name="key_benefit_content_2" class="form-control" placeholder="Enter blog content"> {{ !empty($nonItRecruitment->key_benefit_content_2) ? $nonItRecruitment->key_benefit_content_2 : old('key_benefit_content_2') }} </textarea>
                    ...
                    <div class="mb-3 col-md-6">
                        <label for="" class="form-label">Content 3</label>
                        <textarea type="text" name="key_benefit_content_3" class="form-control" placeholder="Enter content 3"> {{ !empty($nonItRecruitment->key_benefit_content_3) ? $nonItRecruitment->key_benefit_content_3 : old('key_benefit_content_3') }} </textarea>
                    ...
                    <div class="mb-3 col-md-6">
                        ...
                        <textarea type="text" name="key_benefit_content_4" class="form-control" placeholder="Enter blog content"> {{ !empty($nonItRecruitment->key_benefit_content_4) ? $nonItRecruitment->key_benefit_content_4 : old('key_benefit_content_4') }}</textarea>
                    ...
                    <div class="mb-3 col-md-6">
                        ...
                        <textarea type="text" name="key_benefit_content_5" class="form-control" placeholder="Enter content 5"> {{ !empty($nonItRecruitment->key_benefit_content_5) ? $nonItRecruitment->key_benefit_content_5 : old('key_benefit_content_5') }} </textarea>
                ...
                <div class="row">
                    ...
                    <div class="mb-3 col-md-6">
                        <label for="" class="form-label">Content 2</label>
                        <textarea type="text" name="choose_us_content_2" class="form-control" placeholder="Enter blog content">{{ !empty($nonItRecruitment->choose_us_content_2) ? $nonItRecruitment->choose_us_content_2 : old('choose_us_content_2') }}</textarea>
                    ...
                    <div class="mb-3 col-md-6">
                        <label for="" class="form-label">Content 3</label>
                        <textarea type="text" name="choose_us_content_3" class="form-control" placeholder="Enter content 3"> {{ !empty($nonItRecruitment->choose_us_content_3) ? $nonItRecruitment->choose_us_content_3 : old('choose_us_content_3') }} </textarea>
                    ...
                    <div class="mb-3 col-md-6">
                     ...
                     <div class="mb-3 col-md-6">
                        <label for="" class="form-label">Heading 5</label>
                        <input type="text" name="choose_us_heading_5" class="form-control" id="" value="{{ !empty($nonItRecruitment->choose_us_heading_5) ? $nonItRecruitment->choose_us_heading_5 : old('choose_us_heading_5') }}" placeholder="Enter  Heading 5">
                        @if($errors->has('choose_us_heading_4'))
                    ...
                    <div class="mb-3 col-md-6">
                        ...
                        <textarea type="text" name="choose_us_content_5" class="form-control" placeholder="Enter blog content"> {{ !empty($nonItRecruitment->choose_us_content_5) ? $nonItRecruitment->choose_us_content_5 : old('choose_us_content_5') }} </textarea>
                ...
                <div class="row">
                    ...
                    <div class="mb-3 col-md-6">
                        ...
                        <input type="text" name="faq_heading_6" class="form-control" id="" value="{{ !empty($nonItRecruitment->faq_heading_6) ? $nonItRecruitment->faq_heading_6 : old('faq_heading_6') }}" placeholder="Enter  Heading 6">
                    ...
                    <div class="mb-3 col-md-6">
                        ...
                        <textarea type="text" name="faq_content_6" class="form-control" placeholder="Enter content">{{ !empty($nonItRecruitment->faq_content_6) ? $nonItRecruitment->faq_content_6 : old('faq_content_6') }}</textarea>
                    ...
                    <div class="mb-3 col-md-6">
                        ...
                        <input type="file" name="it_hardware_ass_faq_image" class="form-control">
                        @if(!empty($nonItRecruitment->it_hardware_ass_faq_image))
                            <img class="mt-2" src="{{asset('uploads/services/'.$nonItRecruitment->it_hardware_ass_faq_image)}}" height="80"  width="80"  />
                        @endif
                    </div>
                </div>
                <div class="row">
