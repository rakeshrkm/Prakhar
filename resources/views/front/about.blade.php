                ...
                <div class="col-lg-6 col-md-6">
                    <div class="media single-choose-inner">
                        ...
                        <div class="media-body">
                            <h4>{{ $data['chooseUs']->heading_3 }}</h4>
                            <p>{{ $data['chooseUs']->content_3 }}</p>
                            <p class="pt-2"><i class="icomoon-pin"></i>
                                Address - C – 11, LGF, Opp. State Bank of India, Malviya Nagar, New Delhi-110017</p>
            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="single-team-inner text-center">
                        ...
                        <div class="details-wrap">
                            <div class="details-inner">
                                <h4><a href="#">Estoner William</a></h4>
                                <p>HR</p>
                            </div>
                        </div>
                        <div class="hover-details-wrap">
