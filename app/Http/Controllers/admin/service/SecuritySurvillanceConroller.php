...
class SecuritySurvillanceConroller extends Controller
{
    ...
    // Code for FAQ image
        ...
        $faq_image_path = public_path("/uploads/services/" . $securitySurvillance->security_survillance_faq_image);
